...
const mainConfig = require("../../configs/productConfig");
const mainService = require("../../services/productService");
...
exports.getAll = async (req, res, next) => {
  ...
  const data = await mainService.getAllWithPopulates(query, {
    sort: "-createdAt",
    limit: +limit,
    skip: (page - 1) * limit,
  });
...
exports.getForm = async (req, res, next) => {
  ...
  let data = {};
  if (id) {
    data = await mainService.getOneWithPopulates({ _id: id });
  }
