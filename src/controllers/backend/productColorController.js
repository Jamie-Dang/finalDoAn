...
const mainConfig = require("../../configs/productColorConfig");
const mainService = require("../../services/productColorService");
...
exports.saveData = async (req, res, next) => {
  const { id, name, ordering, status, hex } = req.body;

  console.log(req.body);

  const filteredBody = { name, ordering, status, hex };
